...
- [x] 4. Resolve the architectural question this raises: canary/fleet
       ...
       drives.
<!-- DEFERRED 2026-07-26: Tasks 5-9 — pending configuration decisions (canary host, observation window, schedule), skein repo changes, and implementation. Requires operator decisions before implementation can proceed. -->
