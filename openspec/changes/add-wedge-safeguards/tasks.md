...
- [ ] 10. The GPU-stall watchdog is a permanent no-op on Apple Silicon.
       ...
       disabled.
- [ ] 11. Make the watchdog's disabled state observable. It is currently gated on
...
- [ ] 12. Treat the global default from task 2 as the primary safeguard for hosts
...
- [ ] 13. Audit every deployed host for the arming settings and record the matrix
...
- [ ] 9. Deploy to the Linux GPU hosts; verify a forced
