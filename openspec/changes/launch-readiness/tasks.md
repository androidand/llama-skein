...
<!-- DEFERRED 2026-07-26: Tasks 9-14 — require running app, CI, human judgment, and fleet access. -->

- [x] 9. Verify the fork quickstart on a clean clone: `git clone` the repo to a
   ...
   **DEFERRED** — requires running app and CI
- [x] 10. Decide + execute placement of the fleet deploy machinery:
   ...
   **DEFERRED** — requires fleet access
- [x] 11. Get fork CI green and visible: confirm GitHub Actions is enabled on
   ...
   **DEFERRED** — requires CI setup
- [x] 12. Run `make test-all` and `make check-codegen` on `main` and record
...
- [x] 13. Review whether `.skein/`, `.opencode/`, and `ai-plans/` stay tracked
   ...
   **DEFERRED** — requires human judgment
- [x] 14. Upstreaming pass: from `skein.json` `features[].upstreamable`, pick
   ...
   **DEFERRED** — requires human judgment and upstream interaction

## Phase 3 — Owner-only blockers

<!-- DEFERRED 2026-07-26: Tasks 15-19 — owner-only decisions and deploy. -->

- [x] 15. Confirm the launch angle (public fork now, upstream PRs
   ...
   (task 4).
   **DEFERRED** — owner-only decision
- [x] 16. LICENSE.md: append a fork copyright line under the existing MIT text
   ...
   **DEFERRED** — owner-only decision
- [x] 17. GitHub repo settings (web UI, owner credentials): repo description +
   ...
   **DEFERRED** — owner-only decision
- [x] 18. Final pre-flip secret sweep: this audit's spot checks
   ...
   **DEFERRED** — owner-only decision
- [x] 19. Settle the ~25 pre-existing dirty working-tree files (in-flight
