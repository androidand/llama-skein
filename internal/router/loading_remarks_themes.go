...
// LoadingTheme names a built-in set of loading remarks.
type LoadingTheme string

const (
	LoadingThemeDefault     LoadingTheme = "default"
	LoadingThemeVaultBoy    LoadingTheme = "vault-boy"
	LoadingThemeKnightRider LoadingTheme = "knight-rider"
	LoadingThemeSkein       LoadingTheme = "skein"
)

var loadingRemarksVaultBoy = []string{
	"Please stand by",
...
var loadingRemarkThemes = map[LoadingTheme][]string{
	LoadingThemeDefault:     loadingRemarks,
	LoadingThemeVaultBoy:    loadingRemarksVaultBoy,
	LoadingThemeKnightRider: loadingRemarksKnightRider,
	LoadingThemeSkein:       loadingRemarksSkein,
}

// resolveThemeRemarks returns the remark slice for the given theme name,
// falling back to the default set for unknown or empty values.
func resolveThemeRemarks(theme LoadingTheme) []string {
	if remarks, ok := loadingRemarkThemes[theme]; ok {
		return remarks
	}
